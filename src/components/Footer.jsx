...
export default function Footer() {
  const { selectedStore } = useCatering()
      ...
      <div className="glass-dark rounded-t-3xl">
        <div className="max-w-7xl mx-auto px-6 pt-16 pb-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><Link to="/account" className="th-faint hover:text-primary-400 transition-colors duration-300 text-sm">Profile</Link></li>
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <span className="th-faint text-sm">{selectedStore?.address || '2410 Blvd Ste 150, San Ramon, CA 94583'}</span>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <span className="th-faint text-sm">{selectedStore?.phoneNumber || '(123) 456-7890'}</span>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <span className="th-faint text-sm">catering@nova.local</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-black/5 dark:border-white/5 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <span className="th-ghost text-xs">&copy; 2024 Steak 'n Shake Catering. All rights reserved.</span>
            </div>
